...
RUN apk update && apk add --no-cache build-base libxml2-dev libxslt-dev wget bash tzdata postgresql-dev libpq openssh git tar file php7 php7-xml php7-simplexml grep sed
RUN mkdir /app
WORKDIR /app
